...
public class Tx extends JFrame implements ActionListener, KeyListener,
	...
	targetPanel.setBackground(new Color(61,100,101));
	...
	mediaPanel.setBackground(new Color(61,100,101));
	...
	buttonPanel.setBackground(new Color(61,100,101));
	...
	p1.add( label);
	p1.setBackground(new Color(61,100,101));
	...
	p2.setBackground(new Color(61,100,101));
